...
#include "FDGEN.H"
#if GENBORSTYLE
#include <BWCC.H>       /* Borland styles and default functions */
#endif
...
/* my own classes */
#define STATUS_CLASS        "DFCGEN_Stat"
#define INCDECEDIT_CLASS    "DFCGEN_IncDecEdit"
#define DIAG_CLASS          "DFCGEN_Diags"
#define MAINWINDOW_CLASS    "DFCGEN_Main"
